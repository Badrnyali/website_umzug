...
export const Home = {
  hero: {
    ...
    title:
      "Mit TUKS - Wir machen Ihren Umzug stressfrei!",
...
export const Services = {
  'privat': {
    ...
    info: {
      title:
        "Privater Umzug in guten Händen",
      description:
  ...
  'firma': {
    hero: {
      banner: "url('/assets/Banner-3.png')",
      title:
        "Professionelle Büroumzüge  – schnell und sicher ans Ziel",
      checkLists: [
    ...
    info: {
      title:
        " Wir bringen Ihr Unternehmen sicher ans Ziel!",
      description:
  ...
  'senioren': {
    hero: {
      ...
      title:
        "Sorgenfreier Umzug im Alter mit TUKS!",
      checkLists: [
    ...
    info: {
      title:
        "Ihr zuverlässiger Partner für Privaten Seniorenumzüge",
      description:
  ...
  'muell': {
    hero: {
      ...
      title:
        "Schnelle und zuverlässige Entsorgung mit TUKS",
      checkLists: [
        "Fachgerechte Entsorgung",
        "Raustragen der Gegenstände",
      ],
    },
    info: {
      title:
        "Ihr Experte für sperrige Abfälle!",
      description:
  ...
  'internationale': {
    ...
    info: {
      title:
        "Wohnungsauflösung mit den Umzugsprofis aus Berlin",
      description:
